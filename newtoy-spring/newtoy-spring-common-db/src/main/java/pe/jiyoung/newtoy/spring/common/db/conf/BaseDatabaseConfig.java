package pe.jiyoung.newtoy.spring.common.db.conf;

import static pe.jiyoung.newtoy.spring.common.db.conf.DatabaseConstants.DATABASE;
import static pe.jiyoung.newtoy.spring.common.db.conf.DatabaseConstants.FORMAT_SQL;
import static pe.jiyoung.newtoy.spring.common.db.conf.DatabaseConstants.HIBERNATE_DIALECT;
import static pe.jiyoung.newtoy.spring.common.db.conf.DatabaseConstants.HIKARICP;
import static pe.jiyoung.newtoy.spring.common.db.conf.DatabaseConstants.JDBC_DRIVER_CLASSNAME;
import static pe.jiyoung.newtoy.spring.common.db.conf.DatabaseConstants.JDBC_PASSWORD;
import static pe.jiyoung.newtoy.spring.common.db.conf.DatabaseConstants.JDBC_POOL_INIT_SIZE;
import static pe.jiyoung.newtoy.spring.common.db.conf.DatabaseConstants.JDBC_POOL_MAX_SIZE;
import static pe.jiyoung.newtoy.spring.common.db.conf.DatabaseConstants.JDBC_POOL_NAME;
import static pe.jiyoung.newtoy.spring.common.db.conf.DatabaseConstants.JDBC_URL;
import static pe.jiyoung.newtoy.spring.common.db.conf.DatabaseConstants.JDBC_USERNAME;
import static pe.jiyoung.newtoy.spring.common.db.conf.DatabaseConstants.ODS;
import static pe.jiyoung.newtoy.spring.common.db.conf.DatabaseConstants.SHOW_SQL;
import static pe.jiyoung.newtoy.spring.common.db.conf.DatabaseConstants.TOMCAT;
import static pe.jiyoung.newtoy.spring.common.db.conf.DatabaseConstants.UPS;
